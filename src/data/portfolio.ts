import { Terminal, User, Code, Lock, Eye, Zap, Github, Linkedin, Mail, Download } from 'lucide-react'
...
export const skills: SkillCategory[] = [
  { category: 'Professional Development', items: ['Python', 'React', 'TypeScript', 'Node.js', 'Java', 'Spring boot'] },
  { category: 'Cybersecurity', items: ['Kali Linux', 'CTF Challenges', 'Network Analysis', 'Web Security', 'Ethical Hacking'] },
  { category: 'Tools & Technologies', items: ['Git', 'Docker', 'Linux', 'Neovim'] },
  { category: 'Learning Focus', items: ['Penetration Testing', 'Bug Bounty', 'Security Research', 'TryHackMe'] }
]

export const projects: Project[] = [
  {
    title: 'Interactive Terminal Portfolio',
    description: 'A cybersecurity-themed portfolio website with an interactive CTF challenge',
    tech: ['React', 'TypeScript', 'CSS'],
    status: 'Active'
  },
  {
    title: 'Home Network Security Lab',
    description: 'Personal cybersecurity lab for practicing penetration testing and security analysis',
    tech: ['VirtualBox', 'Kali Linux', 'Metasploitable'],
    status: 'Active'
  },
  {
    title: 'CTF Challenge Collection',
    description: 'Personal collection of Capture The Flag challenges and writeups',
